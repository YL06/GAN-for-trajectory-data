...
class Decoder(nn.Module):
    ...
    def __init__(self,decoder_dim, encoder_size=4096,encoder_dim=1, attention_dim=16, dropout=0.5, gan = False):
        ...
        self.tanh = nn.Tanh()  # testing output value with tanh function
    ...
    def forward(self, encoder_out, enter, esc, sequence, sequence_inv, seq_len, teach_rate):
        ...
        for t in range(max_seq):
            ...
            weight_inv = F.softmax(self.attention(h_b[:batch_size_t]), dim=1)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.embedding = nn.Linear(2,64*64)
    ...
    def forward(self, seq, label):
        ...
        x = self.embedding(seq).reshape(-1, l, 64, 64)
